/*
    ...
    ADD COLUMNS TO DAILY THRESHOLDS TO HANDLE FORMULA FOR BASELINE CREATION
    WILL BE FORMULA PARSED AS STRING:

    ALTER TABLE daily_thresholds add column `formula` varchar(250) default null; 

    update daily_thresholds set amount = 515, formula = "(S/9)*5" where threshold_id = 1;




MODIFY JUICE QUERY TO GET GROUPED SUMS OF QUESTIONS FROM FFQ MAP:

select sum((qa.answer_score * fdm.grams_per_recommended_serving)) as 'sum_units', 
 fdm.daily_question_id,  dt.amount, dt.indicator, 
 if( dt.indicator > 0,  sum((qa.answer_score * fdm.grams_per_recommended_serving)) > dt.amount,  
 sum((qa.answer_score * fdm.grams_per_recommended_serving)) < dt.amount ) as success 
 from question_answers qa  join questions q on q.question_id = qa.question_id 
 ...
 where qa.question_answer_submission_id = 8  
 group by fdm.daily_question_id  order by fdm.daily_question_id
...
CREATE TABLE question_answers (
  ...
  answer_score float(5) DEFAULT NULL,
  FOREIGN KEY (question_id) REFERENCES questions (question_id),
  FOREIGN KEY (question_answer_submission_id) REFERENCES question_answer_submissions (submission_id)
);

create table ffq_daily_map (
    map_id int not null,
    ffq_question_id int not null,
    daily_question_id int not null,
    grams_per_recommended_serving float(2) not null,
    primary key (map_id)
);

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 3, 81, 245 );
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 4, 71, 170 );
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 6, 71, 109 );
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 7, 71, 56 );
-- Query OK, 1 row affected (0.01 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 8, 61, 118 );
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 9, 61, 169 );
-- Query OK, 1 row affected (0.01 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 10, 61, 75 );
-- Query OK, 1 row affected (0.01 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 11, 61, 118.5 );
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 12, 82, 248 );
-- Query OK, 1 row affected (0.01 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 13, 61, 61.5 );
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 14, 61, 62.5 );
-- Query OK, 1 row affected (0.01 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 15, 61, 75 );
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 16, 61, 103 );
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 17, 61, 144 );
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 18, 66, 82.5 );
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 19, 72, 113.2 );
-- Query OK, 1 row affected (0.01 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 20, 74, 67 );
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 21, 74, 23.4 );
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 22, 72, 113.2 );
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 23, 74, 38 );
-- Query OK, 1 row affected (0.01 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 24, 68, 172 );
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 25, 68, 113.2 );
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 26, 68, 113.2 );
-- Query OK, 1 row affected (0.01 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 27, 70, 50 );
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 28, 64, 28 );
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 29, 64, 37 );
-- Query OK, 1 row affected (0.01 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 30, 64, 32 );
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 36, 64, 162.5 );
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 36, 63, 162.5 );
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 37, 64, 88.5 );
-- Query OK, 1 row affected (0.01 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 38, 64, 62 );
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 39, 78, 237 );
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 40, 80, 237 );
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 41, 84, 370 );
-- Query OK, 1 row affected (0.01 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 42, 83, 370 );
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 43, 85, 356 );
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 44, 85, 147 );
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 45, 85, 42 );
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 46, 76, 44 );
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 47, 76, 73 );
-- Query OK, 1 row affected (0.01 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 49, 76, 37 );
-- Query OK, 1 row affected (0.01 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 50, 76, 40 );
-- Query OK, 1 row affected (0.01 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 51, 67, 30 );
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 52, 76, 62 );
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 53, 75, 14 );
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 57, 77, 6 );
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 13, 62, 62.5 );
-- Query OK, 1 row affected (0.01 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 14, 62, 62.5 );
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 14, 62, 75 );
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 15, 62, 75 );
-- Query OK, 1 row affected (0.01 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 16, 62, 103 );
-- Query OK, 1 row affected (0.01 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 17, 62, 144 );
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 30, 65, 32 );
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 26, 69, 113.2 );
-- Query OK, 1 row affected (0.01 sec)

-- mysql> insert into ffq_daily_map (map_id, ffq_question_id, daily_question_id, grams_per_recommended_serving) values ( DEFAULT, 19, 73, 113.2 );

-- select * from questions q join ffq_daily_map fdm on fdm.ffq_question_id = q.question_id order by q.question_id;
create table daily_thresholds (
    threshold_id int not null PRIMARY KEY AUTO_INCREMENT,
    question_id int not null,
    amount float(2) not null,
    indicator tinyint not null
);

-- mysql> insert into daily_thresholds (threshold_id, question_id, amount, indicator) values (DEFAULT, 61, 103, 1)
--     -> ;
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into daily_thresholds (threshold_id, question_id, amount, indicator) values (DEFAULT, 62, 268, 1);
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into daily_thresholds (threshold_id, question_id, amount, indicator) values (DEFAULT, 63, 162, 1);
-- Query OK, 1 row affected (0.01 sec)

-- mysql> insert into daily_thresholds (threshold_id, question_id, amount, indicator) values (DEFAULT, 64, 55, -1);
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into daily_thresholds (threshold_id, question_id, amount, indicator) values (DEFAULT, 65, 0, 0);
-- Query OK, 1 row affected (0.01 sec)

-- mysql> insert into daily_thresholds (threshold_id, question_id, amount, indicator) values (DEFAULT, 66, 47, 1);
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into daily_thresholds (threshold_id, question_id, amount, indicator) values (DEFAULT, 67, 13, 1);
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into daily_thresholds (threshold_id, question_id, amount, indicator) values (DEFAULT, 68, 57, 1);
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into daily_thresholds (threshold_id, question_id, amount, indicator) values (DEFAULT, 69, 0, 0);
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into daily_thresholds (threshold_id, question_id, amount, indicator) values (DEFAULT, 70, 0, -1);
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into daily_thresholds (threshold_id, question_id, amount, indicator) values (DEFAULT, 71, 224, -1);
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into daily_thresholds (threshold_id, question_id, amount, indicator) values (DEFAULT, 72, 49, -1);
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into daily_thresholds (threshold_id, question_id, amount, indicator) values (DEFAULT, 73, 0, 1);
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into daily_thresholds (threshold_id, question_id, amount, indicator) values (DEFAULT, 74, 6, -1);
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into daily_thresholds (threshold_id, question_id, amount, indicator) values (DEFAULT, 75, 0, 1);
-- Query OK, 1 row affected (0.01 sec)

-- mysql> insert into daily_thresholds (threshold_id, question_id, amount, indicator) values (DEFAULT, 76, 7, -1);
-- Query OK, 1 row affected (0.01 sec)

-- mysql> insert into daily_thresholds (threshold_id, question_id, amount, indicator) values (DEFAULT, 77, 0, -1);
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into daily_thresholds (threshold_id, question_id, amount, indicator) values (DEFAULT, 78, 1896, 1);
-- Query OK, 1 row affected (0.01 sec)

-- mysql> insert into daily_thresholds (threshold_id, question_id, amount, indicator) values (DEFAULT, 79, 245, 1);
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into daily_thresholds (threshold_id, question_id, amount, indicator) values (DEFAULT, 80, 237, 1);
-- Query OK, 1 row affected (0.01 sec)

-- mysql> insert into daily_thresholds (threshold_id, question_id, amount, indicator) values (DEFAULT, 81, 245, -1);
-- Query OK, 1 row affected (0.01 sec)

-- mysql> insert into daily_thresholds (threshold_id, question_id, amount, indicator) values (DEFAULT, 82, 248, -1);
-- Query OK, 1 row affected (0.01 sec)

-- mysql> insert into daily_thresholds (threshold_id, question_id, amount, indicator) values (DEFAULT, 83, 370, -1);
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into daily_thresholds (threshold_id, question_id, amount, indicator) values (DEFAULT, 83, 370, -1);
-- Query OK, 1 row affected (0.00 sec)

-- mysql> insert into daily_thresholds (threshold_id, question_id, amount, indicator) values (DEFAULT, 84, 1, -1);
-- Query OK, 1 row affected (0.01 sec)
